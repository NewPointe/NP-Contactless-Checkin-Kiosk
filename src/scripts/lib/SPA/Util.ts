 ...
 */
export function applyAutofocus(element: HTMLElement): void {
 ...
 */
function encodeInvalidCssCharacter(character: string): string {
 ...
 */
export function toCssClass(text: string): string {
