...
export class Tag<TagName extends ElementNames> {
     ...
     */
    public get(): ElementWithName<TagName> {
        return this.element;
    }
     ...
     */
    public properties(properties: Partial<WritableElementProperties<TagName>>): this {
     ...
     */
    public attributes(attributes: { [name: string]: string }): this {
    ...
    public classes(...classes: string[]): this {
        this.element.classList.add(...classes.map(s => s.split(" ")).flat());
        return this;
    }
     ...
     */
    public aria(key: string, value: string): this {
     ...
     */
    public show(display = "block"): this {
     ...
     */
    public content(...content: Array<TagContent<ElementNames>>): this {
     ...
     */
    public with(fn: (el: ElementWithName<TagName>) => unknown): this {
        fn(this.element);
        return this;
    }
...
function simpleTagFactory<U extends ElementNames>(tagName: U) {
    return (...content: Array<TagContent<ElementNames>>): Tag<U> => new Tag<U>(tagName).content(...content);
}
...
export namespace Tag {
    ...
    export const div = (...classes: string[]): Tag<"div"> => new Tag("div").classes(...classes);
    export const label = (forId: string, text: string): Tag<"label"> => new Tag("label").property("htmlFor", forId).content(text);
    export const a = (href: string): Tag<"a"> => new Tag("a").property("href", href);
    export const img = (src: string): Tag<"img"> => new Tag("img").property("src", src);
    export const input = (type: string): Tag<"input"> => new Tag("input").property("type", type);
    export const button = (type: string): Tag<"button"> => new Tag("button").property("type", type);
}
